( Version of Klaus Schleisiek's dynamic memory alloc.   1 / 4 )
(
(         |<------------- len ------------->|
( 0       |2      4                         |
( ---------------------------------------------------
...
(        anchor
(
( address of >PTR is the reference address of a memory block which becomes the address of useable memory after allocation.
(
...
( Version of Klaus Schleisiek's dynamic memory alloc.   2 / 4 )
...
( Version of Klaus Schleisiek's dynamic memory alloc.   3 / 4 )
: FITS? ( size -- mem | false )
   >R ANCHOR @
...
( Version of Klaus Schleisiek's dynamic memory alloc.   4 / 4 )
