...
;     and modified by feilipu for z88dk
;
; Original code: https://github.com/RC2014Z80/RC2014/blob/master/BASIC-Programs/hexload/hexload.asm
;
; No Licence found, so assuming a permissive public licence, attribition given.
