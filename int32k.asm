...
COLDSTART:
        ...
        LD (basicStarted),A
        JP main_code_start                    ; <<<< Start Basic COLD:
CHECKWARM:
        CP 'W'
        JR NZ,CORW
        RST 08H
        ...
        RST 08H
WARMSTART:
        JP main_code_warmstart                    ; <<<< Start Basic WARM:
...
SIGNON1:        DEFM    CHAR_CR,CHAR_LF
                DEFM    "RC2014 - CamelForth BootROM",CHAR_CR,CHAR_LF
                DEFM    "z88dk - feilipu",CHAR_CR,CHAR_LF
                DEFM    "BootROM modifications - Justin Skists",CHAR_CR,CHAR_LF,0
SIGNON2:        DEFM    CHAR_CR,CHAR_LF
